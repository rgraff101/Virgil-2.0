...
def handle_command(command):
    ...
    if command == "FORWARD":
        ...
        spin(math.pi / 1.5, 0.4)
    elif command == "45RIGHT":
        spin(-math.pi / 2.5, 0.4)
    elif command == "30RIGHT":
        spin((-math.pi / 2.5) * .5, 0.4)
    elif command == "FORWARD1":
        straight_forward(.9)
    elif command == "FORWARD2":
        straight_forward(2)
    elif command == "FORWARD5":
        straight_forward(5)
    elif command == "FORWARD20":
        straight_forward(20)
    elif command == "FORWARD30":
        straight_forward(30)
    elif command == "FORWARD15":
        straight_forward(15)
    elif command == "RAMP":
        lm.reset_encoder()
        rm.reset_encoder()
